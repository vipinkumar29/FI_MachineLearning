...
import com.deloitte.aiml.knn.web.execution.CosineSimilarity;
import com.deloitte.aiml.knn.web.execution.EuclideanDistance;
import com.deloitte.aiml.knn.web.execution.FileManager;
import com.deloitte.aiml.knn.web.execution.L1Distance;
import com.deloitte.aiml.knn.web.execution.Metric;
import com.deloitte.aiml.knn.web.execution.TestRecord;
import com.deloitte.aiml.knn.web.execution.TrainRecord;

@RestController
@RequestMapping(value="/aiSuit")
public class KNNControllerImpl {
	
	
	@RequestMapping(value="/callKnnImpl", method = RequestMethod.GET)
	@ResponseBody
	public static void getSaveKnnPrediction(HttpServletRequest request,HttpServletResponse response,
			HttpSession session,RedirectAttributes redirectAttributes,ModelMap modelMap){	
		System.out.println("Glass");
		File file1 = new File("C:\\Users\\soumsarkar\\Documents\\New folder\\readTxt\\glassTrain.txt");
		File file2 = new File("C:\\Users\\soumsarkar\\Documents\\New folder\\readTxt\\glassTest.txt");
		knn(file1.getAbsolutePath(),file2.getAbsolutePath(),1,2);
		//.out.println();

		System.out.println("glass");
		//knn(file1.getAbsolutePath(),file2.getAbsolutePath(),5,0);
