...
public class ANNControllerImpl {

	private int slidingWindowSize;
	private double max = 0;
	private double min = Double.MAX_VALUE;
	private String rawDataFilePath;
	private String readDataFilePathFromProp = "C:\\Users\\soumsarkar\\Documents\\New folder\\readTxt\\rawTrainingData.csv";
	...
	{
		rawDataFilePath = readDataFilePathFromProp;
		slidingWindowSize = 5;
	}

	@RequestMapping(value="/callAnnImpl", method = RequestMethod.GET)
	@ResponseBody
	public void getSaveLogRegPrediction(HttpServletRequest request,HttpServletResponse response,
			HttpSession session,RedirectAttributes redirectAttributes,ModelMap modelMap) throws IOException {

		//ANNController predictor = new ANNController(5, "C:\\Users\\soumsarkar\\Documents\\New folder\\readTxt\\rawTrainingData.csv");
		ANNControllerImpl predictor = new ANNControllerImpl();
	...
	/*public ANNController(int slidingWindowSize, String rawDataFilePath) {
