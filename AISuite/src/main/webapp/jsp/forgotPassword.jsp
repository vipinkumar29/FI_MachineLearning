					...
					<div class="panel">
								...
								<div class="col-sm-12">
									<form method="POST" commandName="loginForm" action="${pageContext.request.contextPath}/fi/landingPage" id="login-form" role="form" class="">
										...
										<div class="form-group pull-right">
											<button id="loginBtn" ng-click="login()" ng-disabled="loggingIn" class="form-control btn btn-primary">Submit</button>
										</div>
									</form>
								</div>
							</div>
						...
						<div class="panel-footer">
							<div class="form-group">
								...
								<a href=onclick="javascript:window.location.href = '${pageContext.request.contextPath}/fi/welcome'" class="pull-right">Resend Activation Mail</a>
							</div>
						</div>
					</div>
