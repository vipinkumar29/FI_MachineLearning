                    ...
                    <form:form commandName="fiThreadsForm" action="">
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						    ...
						    <p style="font-size:25px; padding:7px 5px 0 20px;">Open Threads:</p>
									...
									<c:when test="${fiThreadsForm.status == 'Success'}">
										...
										<tr bgcolor="ffd9b3"><!-- ffe6e6 -->
											...
											<%-- <td class="gradeA">
			                                    ...
			                                    <div class="radio" >
			                                        <label>
			                                            <a href="${pageContext.request.contextPath}/fiseeker/seekaersThread/${fiThreads.id}"></a>
			                                        	<form:radiobutton  class="radio" path="status" id="status" value="true" />Yes
			                                        </label>
			                                    </div>
			                                   </td> --%>
											<%-- <td class="gradeA"><c:out value="${fiThreads.agentType}" /></td> --%>
